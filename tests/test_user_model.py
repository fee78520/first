...
class UserModelTestCase(unittest.TestCase):
    ...
    #     with self.app.test_request_context('/'):
    #         image = u.image()
    #         image_256 = u.image(size=256)
    #         image_pg = u.image(rating='pg')
    #         image_retro = u.image(default='retro')
    #     # self.assertTrue('https://secure.gravatar.com/avatar/' +
    #     #                 'd4c74594d841139328695756648b6bd6'in image)
    #     self.assertTrue('s=256' in image_256)
    #     self.assertTrue('r=pg' in image_pg)
    #     self.assertTrue('d=retro' in image_retro)
